...
def setup_cryptomatte_ui():
    if nuke.GUI:
        ...
        menu = toolbar.addMenu("Channel/Cryptomatte", "cryptomatte_logo.png",index=-1)
        menu.addCommand("Channel/Cryptomatte", "import cryptomatte_utilities as cu; cu.cryptomatte_create_gizmo();")
        menu.addCommand("Channel/Decryptomatte All", "import cryptomatte_utilities as cu; cu.decryptomatte_all();")
        menu.addCommand("Channel/Decryptomatte Selection", "import cryptomatte_utilities as cu; cu.decryptomatte_selected();")
        menu.addCommand("Channel/Encryptomatte", "import cryptomatte_utilities as cu; cu.encryptomatte_create_gizmo();")
